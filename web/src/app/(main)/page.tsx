  ...
  return (
    <div className="space-y-6">
      ...
      <section className="grid min-w-0 gap-4 lg:grid-cols-2">
        <div className="min-w-0 h-full rounded-xl border border-zinc-200 bg-white p-4">
            ...
            <ul className="space-y-2">
              {latestDigests.map((d) => (
                <li key={d.id}>
                  <Link
                    href={`/digests/${d.id}`}
                    className="flex min-w-0 items-center justify-between gap-3 rounded-lg border border-zinc-200 px-3 py-2 hover:bg-zinc-50"
                  >
                    <div className="min-w-0">
                      <div className="truncate text-sm font-medium text-zinc-900">{d.digest_date}</div>
