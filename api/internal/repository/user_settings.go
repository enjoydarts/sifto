...
func (r *UserSettingsRepo) GetByUserID(ctx context.Context, userID string) (*model.UserSettings, error) {
	...
	err := r.db.QueryRow(ctx, `
		SELECT user_id,
		       ...
		       facts_secondary_rate_percent,
		       facts_fallback_model,
		       summary_model,
		       summary_secondary_model,
		       summary_secondary_rate_percent,
		...
		&v.FactsModel,
		&v.FactsSecondaryModel,
		&v.FactsSecondaryRatePercent,
		&v.FactsFallbackModel,
		&v.SummaryModel,
		&v.SummarySecondaryModel,
		&v.SummarySecondaryRatePercent,
	...
	_, err := r.db.Exec(ctx, `
		INSERT INTO user_settings (
			...
			SET facts_model = EXCLUDED.facts_model,
			    ...
			    facts_secondary_rate_percent = EXCLUDED.facts_secondary_rate_percent,
			    facts_fallback_model = EXCLUDED.facts_fallback_model,
			    summary_model = EXCLUDED.summary_model,
			    summary_secondary_model = EXCLUDED.summary_secondary_model,
			    summary_secondary_rate_percent = EXCLUDED.summary_secondary_rate_percent,
...
func (r *UserSettingsRepo) GetFeatherlessAPIKeyEncrypted(ctx context.Context, userID string) (*string, error) {
	var v *string
	err := r.db.QueryRow(ctx, `
...
func (r *UserSettingsRepo) GetAlibabaAPIKeyEncrypted(ctx context.Context, userID string) (*string, error) {
	var v *string
	err := r.db.QueryRow(ctx, `
		SELECT alibaba_api_key_enc
		FROM user_settings
		WHERE user_id = $1`,
		userID,
	).Scan(&v)
...
func (r *UserSettingsRepo) GetElevenLabsAPIKeyEncrypted(ctx context.Context, userID string) (*string, error) {
	var v *string
	err := r.db.QueryRow(ctx, `
...
func (r *UserSettingsRepo) SetFeatherlessAPIKey(ctx context.Context, userID, encryptedKey, last4 string) (*model.UserSettings, error) {
	_, err := r.db.Exec(ctx, `
		...
		VALUES ($1, $2, $3)
		ON CONFLICT (user_id) DO UPDATE
		SET featherless_api_key_enc = EXCLUDED.featherless_api_key_enc,
		    featherless_api_key_last4 = EXCLUDED.featherless_api_key_last4,
		    updated_at = NOW()`,
		userID, encryptedKey, last4,
	)
	if err != nil {
...
func (r *UserSettingsRepo) SetAlibabaAPIKey(ctx context.Context, userID, encryptedKey, last4 string) (*model.UserSettings, error) {
	_, err := r.db.Exec(ctx, `
		INSERT INTO user_settings (user_id, alibaba_api_key_enc, alibaba_api_key_last4)
		VALUES ($1, $2, $3)
		ON CONFLICT (user_id) DO UPDATE
		SET alibaba_api_key_enc = EXCLUDED.alibaba_api_key_enc,
...
func (r *UserSettingsRepo) SetMistralAPIKey(ctx context.Context, userID, encryptedKey, last4 string) (*model.UserSettings, error) {
	_, err := r.db.Exec(ctx, `
		INSERT INTO user_settings (user_id, mistral_api_key_enc, mistral_api_key_last4)
		VALUES ($1, $2, $3)
		ON CONFLICT (user_id) DO UPDATE
		SET mistral_api_key_enc = EXCLUDED.mistral_api_key_enc,
		    mistral_api_key_last4 = EXCLUDED.mistral_api_key_last4,
		    updated_at = NOW()`,
		userID, encryptedKey, last4,
	)
	if err != nil {
...
func (r *UserSettingsRepo) SetElevenLabsAPIKey(ctx context.Context, userID, encryptedKey, last4 string) (*model.UserSettings, error) {
	_, err := r.db.Exec(ctx, `
		INSERT INTO user_settings (user_id, elevenlabs_api_key_enc, elevenlabs_api_key_last4)
		VALUES ($1, $2, $3)
		ON CONFLICT (user_id) DO UPDATE
		SET elevenlabs_api_key_enc = EXCLUDED.elevenlabs_api_key_enc,
		    elevenlabs_api_key_last4 = EXCLUDED.elevenlabs_api_key_last4,
		    updated_at = NOW()`,
		userID, encryptedKey, last4,
	)
	if err != nil {
...
func (r *UserSettingsRepo) ClearFeatherlessAPIKey(ctx context.Context, userID string) (*model.UserSettings, error) {
	_, err := r.db.Exec(ctx, `
		INSERT INTO user_settings (user_id, featherless_api_key_enc, featherless_api_key_last4)
		VALUES ($1, NULL, NULL)
		ON CONFLICT (user_id) DO UPDATE
		SET featherless_api_key_enc = NULL,
		    featherless_api_key_last4 = NULL,
		    updated_at = NOW()`,
		userID,
	)
	if err != nil {
...
func (r *UserSettingsRepo) ClearAlibabaAPIKey(ctx context.Context, userID string) (*model.UserSettings, error) {
	_, err := r.db.Exec(ctx, `
		INSERT INTO user_settings (user_id, alibaba_api_key_enc, alibaba_api_key_last4)
		VALUES ($1, NULL, NULL)
		ON CONFLICT (user_id) DO UPDATE
...
func (r *UserSettingsRepo) ClearMistralAPIKey(ctx context.Context, userID string) (*model.UserSettings, error) {
	_, err := r.db.Exec(ctx, `
		INSERT INTO user_settings (user_id, mistral_api_key_enc, mistral_api_key_last4)
		VALUES ($1, NULL, NULL)
		ON CONFLICT (user_id) DO UPDATE
...
func (r *UserSettingsRepo) ClearElevenLabsAPIKey(ctx context.Context, userID string) (*model.UserSettings, error) {
	_, err := r.db.Exec(ctx, `
		INSERT INTO user_settings (user_id, elevenlabs_api_key_enc, elevenlabs_api_key_last4)
		VALUES ($1, NULL, NULL)
		ON CONFLICT (user_id) DO UPDATE
