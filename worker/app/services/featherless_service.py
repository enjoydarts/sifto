...
_config = ProviderConfig(
    ...
    env_prefix="FEATHERLESS",
    pricing_source_version="featherless_static_2026_04",
    api_base_url="https://api.featherless.ai/v1/chat/completions",
    api_base_url_env="FEATHERLESS_API_BASE_URL",
