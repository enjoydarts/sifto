...
class FeedTaskCommonTests(unittest.TestCase):
    ...
    def test_build_audio_briefing_script_task_uses_full_persona_and_fixed_article_order(self):
        ...
        self.assertIn("headline では、その記事をリスナーに紹介するつもりで話してよい。何の記事で、どこが気になるのかが自然に伝わるようにする", prompt)
        ...
        self.assertIn("headline でこれから扱う記事をリスナーに紹介し、commentary でそのペルソナの反応を書く", prompt)
