...
class GeminiServiceTests(unittest.TestCase):
    ...
    def test_summarize_keeps_genre_from_structured_output(self, generate_content, _summary_context_cache_enabled):
        generate_content.return_value = (
            '{"summary":"要約です。","topics":["AI"],"genre":"技術","translated_title":"翻訳済みタイトル","score_breakdown":{"importance":0.8,"novelty":0.5,"actionability":0.6,"reliability":0.9,"relevance":0.7},"score_reason":"理由です。"}',
