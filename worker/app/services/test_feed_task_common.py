...
class FeedTaskCommonTests(unittest.TestCase):
    ...
    def test_build_audio_briefing_script_task_uses_full_persona_and_fixed_article_order(self):
        ...
        self.assertIn("headline は 3〜5文", prompt)
        self.assertIn("summary_intro は 9〜10文", prompt)
        self.assertIn("commentary は 13〜14文", prompt)
        ...
        self.assertIn("反応の理由、比較、引っかかり、今追う意味のうち複数を必ず入れる", prompt)
