...
_config = ProviderConfig(
    provider_name="plamo",
    env_prefix="PLAMO",
    pricing_source_version="plamo_manual_jpy_2026_06_usd150",
    api_base_url="https://api.platform.preferredai.jp/v1/chat/completions",
    api_base_url_env="PLAMO_API_BASE_URL",
    default_model="plamo-3.0-prime",
    default_translate_model="plamo-3.0-prime",
)
