...
def _chat_completions_url(raw_base_url: str) -> str:
    ...
    if base.endswith("/v1/openai/chat/completions"):
        return base
    if base.endswith("/v1/openai"):
        return f"{base}/chat/completions"
    if base.endswith("/v1"):
        return f"{base}/openai/chat/completions"
    return f"{base}/v1/openai/chat/completions"


class _DeepInfraProvider(OpenAICompatProvider):
...
_config = ProviderConfig(
    ...
    pricing_source_version="deepinfra_snapshot",
