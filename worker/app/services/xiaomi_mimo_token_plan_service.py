...
class _XiaomiMiMoTokenPlanProvider(OpenAICompatProvider):
    def _get_chat_url(self) -> str:
        return _chat_completions_url(os.getenv(self.config.api_base_url_env, ""))


_config = ProviderConfig(
    provider_name="xiaomi_mimo_token_plan",
    env_prefix="XIAOMI_MIMO_TOKEN_PLAN",
    pricing_source_version="xiaomi_mimo_token_plan_subscription_2026_04",
    api_base_url="https://token-plan-sgp.xiaomimimo.com/v1/chat/completions",
    api_base_url_env="XIAOMI_MIMO_TOKEN_PLAN_API_BASE_URL",
    auth_header_name="api-key",
    auth_scheme="",
)
_p = _XiaomiMiMoTokenPlanProvider(_config)
