...
class ClaudeServiceTests(unittest.TestCase):
    def test_llm_meta_prices_opus_5_5_family(self):
        class _Message:
        ...
        llm = _llm_meta(_Message(), "summary", "claude-opus-5-5")
        self.assertEqual(llm["pricing_model_family"], "claude-opus-5-5")
        self.assertEqual(llm["pricing_source"], "anthropic_static_2026_09")
        self.assertEqual(llm["estimated_cost_usd"], 14.54)

    def test_llm_meta_prices_fable_5_1_family(self):
        class _Message:
        ...
        llm = _llm_meta(_Message(), "summary", "claude-fable-5-1")
        self.assertEqual(llm["pricing_model_family"], "claude-fable-5-1")
        self.assertEqual(llm["pricing_source"], "anthropic_static_2026_09")
        self.assertEqual(llm["estimated_cost_usd"], 36.3)

    def test_llm_meta_prices_opus_5_family(self):
        class _Message:
            model = "claude-opus-5"
            usage = type(
                "Usage",
        ...
        llm = _llm_meta(_Message(), "summary", "claude-opus-5")
        self.assertEqual(llm["pricing_model_family"], "claude-opus-5")
        self.assertEqual(llm["pricing_source"], "anthropic_static_2026_07")
        self.assertEqual(llm["estimated_cost_usd"], 18.225)
