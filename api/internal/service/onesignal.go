...
func (c *OneSignalClient) SendToSubscriptionID(ctx context.Context, subscriptionID, title, body, targetURL string, data map[string]any) (*OneSignalSendResult, error) {
	if !c.Enabled() {
		return nil, nil
	}
